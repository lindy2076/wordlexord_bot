class Response:
    ...
    NO_ALPHABET = "такого алфавита пока нет... напиши *инфо*, там есть необходимая информация"
    ...
    WORD_TOO_LONG = "в запросе присутствует очень длинное слово/число. ограничение - не более 2000 символов/3000 цифр"
    TOO_MANY_WORDS = "в запросе очень много слов/чисел. ограничение - не более 100 слов"
